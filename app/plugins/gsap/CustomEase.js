...
_gsScope._gsDefine(
  ...
  function() {
    ...
    const _bezierToPoints = function(
      x1,
      y1,
      x2,
      y2,
    ...
    const _findMinimum = function(values) {
    ...
    const _normalize = function(values, height, originY) {
    ...
    const CustomEase = function(id, data, config) {
      this._calcEnd = true
      this.id = id
      if (id) {
        Ease.map[id] = this
    ...
    const p = (CustomEase.prototype = new Ease())
...
export const CustomEase = globals.CustomEase
